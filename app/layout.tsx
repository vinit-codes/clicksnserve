...
export const metadata: Metadata = {
  title: "Clicks & Serve - Dermatology Clinic Growth Agency | Scale Your Business",
  ...
  keywords: ["Dermatology Clinic marketing", "Clinic growth", "content creation", "digital marketing", "restaurant website", "social media marketing"],
